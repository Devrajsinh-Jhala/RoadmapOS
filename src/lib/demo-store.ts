...
function createInitialState(): DemoState {
  ...
  const goals: Goal[] = [
    {
      ...
      domain: "wealth",
      description: "Build a property corpus without sacrificing the emergency reserve.",
      deadline: "2028-07-01",
    ...
    },
    {
      id: "goal-career",
      userId: DEMO_USER_ID,
      title: "Move into a stronger engineering role",
      domain: "career",
      description: "Build interview skills and proof of work with consistent practice.",
      deadline: "2027-01-31",
      targetAmount: 0,
      weeklyHours: 7,
      priority: 1,
    ...
    },
    {
      id: "goal-ai",
      userId: DEMO_USER_ID,
      title: "Build an applied AI portfolio",
      domain: "skills",
      description: "Learn enough applied AI to ship two useful projects.",
      deadline: "2026-12-31",
      targetAmount: 15000,
      weeklyHours: 5,
      priority: 2,
    ...
    },
    {
      id: "goal-gym",
      userId: DEMO_USER_ID,
      title: "Build a sustainable strength routine",
      domain: "health",
    ...
    },
    {
      id: "goal-watch",
      userId: DEMO_USER_ID,
      title: "Upgrade the work setup",
      domain: "lifestyle",
      description: "Buy only if it does not break the home sequence.",
      deadline: "2026-09-30",
      targetAmount: 45000,
      weeklyHours: 0,
      priority: 5,
  ...
  const roadmap: RoadmapVersion = {
    ...
    userId: DEMO_USER_ID,
    trigger: "demo-seed",
    summary: "Career growth and the home corpus stay ahead of lifestyle rewards.",
    structured,
